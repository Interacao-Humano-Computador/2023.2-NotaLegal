...
O teste piloto desta avaliação foi realizado no dia 04/11/2023, às 17h, e durou cerca de 5 minutos. No teste, tivemos o integrante [Lucas Ribeiro](https://github.com/lucassouzs) como mediador, e o integrante [Lucas Victor](https://github.com/Lucas13032003) como participante do teste. O termo de consentimento livre e esclarecido foi lido para o participante, e ao aceite, o teste seguiu. Todas as perguntas propostas nesta avaliação foram lidas para o participante e respondidas pelo mesmo. Ao realizar o teste piloto, é possível chegar a conclusões importantes. Este teste permite avaliar a validade do protótipo de papel em relação à execução das tarefas pelos usuários no site do "Nota Legal". Além disso, ele oferece a oportunidade de verificar se as motivações e satisfações dos usuários estão adequadamente representadas, bem como identificar erros e áreas que necessitam de melhorias. O vídeo 1 apresenta o registro do teste piloto realizado.
