...
O relato dos resultados da avaliação do protótipo de papel deve incluir, de acordo com Barbosa e Diniz [1], os seguintes tópicos:
...
| `1.2`  | 06/11/2023 | Adição da introdução, metodologia e objetivos gerais |   [Gabriel Zaranza](https://github.com/GZaranza)   |  [Lucas Ribeiro](https://github.com/lucassouzs)  |
| `1.3`  | 06/11/2023 | Adição dos aspectos éticos, avaliação e apresentação dos dados e documento modelo |   [Zenilda Veiira](https://github.com/zenildavieira)   |  [Lucas Ribeiro](https://github.com/lucassouzs)  |