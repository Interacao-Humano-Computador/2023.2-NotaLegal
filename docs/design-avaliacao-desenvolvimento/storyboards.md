# Storyboards do site "Nota Legal"
...
<div align="center">
<p>Tabela 1 - Definição de membro da equipe que trabalhou em determinado storyboard. </p>
</div>

| Membro da Equipe | Storyboard  |
| ------------------------------------------------------------------------ | ---------------------------    |
...
| [Lucas Víctor](https://github.com/Lucas13032003)                         | Indicação de créditos     |
...
Na Figura X a seguir é apresentado o StoryBoard da tarefa “consultar resultado de sorteio”.


<div align="center">
<p>Figura X - Storyboard da tarefa Consultar resultado de sorteio </p>
