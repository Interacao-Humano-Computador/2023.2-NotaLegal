...
Na Tabela 4, estão listados os critérios que devem ser verificados no artefato [Planejamento da Avaliação do Protótipo de Papel](https://github.com/Interacao-Humano-Computador/2023.2-Ventoy/blob/main/docs/DAD/nivel2/prototipoDePapel/planejamento.md) do [Grupo 2](https://github.com/Interacao-Humano-Computador/2023.2-Ventoy/tree/main).

<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 4:</b> Checklist Planejamento da Avaliação do Protótipo de Papel</p></font>
...
### Checklist do Artefato Planejamento do Relato dos Resultados do Protótipo de Papel

Na Tabela 5, estão listados os critérios que devem ser verificados no artefato [Planejamento do Relato dos Resultados do Protótipo de Papel](https://github.com/Interacao-Humano-Computador/2023.2-Ventoy/blob/main/docs/DAD/nivel2/prototipoDePapel/plan_relato.md) do [Grupo 2](https://github.com/Interacao-Humano-Computador/2023.2-Ventoy/tree/main).

<div align="center">
<font size="3"><p style="text-align: center"><b>Tabela 5:</b> Checklist Planejamento do Relato dos Resultados do Protótipo de Papel</p></font>
