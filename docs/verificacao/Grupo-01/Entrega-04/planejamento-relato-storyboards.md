...
Na tabela 1, é possível visualizar os resultados obtidos na verificação do artefato "[Planejamento do Relato dos Resultados da Avaliação do Storyboard](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento/planejamento-relato_storyboard/)" em relação ao checklist geral.
...
Na tabela 2, é possível visualizar os resultados obtidos na verificação do artefato "[Planejamento do Relato dos Resultados da Avaliação do Storyboard](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento/planejamento-relato_storyboard/)" em relação ao checklist específico.
...
Nesta seção, serão apresentados os problemas encontrados durante a verificação do artefato "[Planejamento do Relato dos Resultados da Avaliação do Storyboard](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento/planejamento-relato_storyboard/)".

### Checklist Geral

- **ID 2, 3 e 4:** O artefato possui apenas a sessão de bibliografia, porém não possui nenhuma referência bibliográfica. O que está incorreto, visto que as fontes presentes na bibliografia são citadas no texto e deveriam estar na sessão de referências bibliográficas.
    - **Correção:** A sessão de bibliografia foi renomeada para referências bibliográficas e as referências foram organizadas de acordo com a ordem em que aparecem no texto.
...
- **ID 7:** O artefato não cita como o cronograma executado deve ser apresentado.
    - **Correção:** O artefato foi atualizado para descrever com uma tabela que mostra o modelo do cronograma executado.

## Resultados

Nesta seção, serão apresentados os resultados obtidos na verificação do artefato "[Planejamento do Relato dos Resultados da Avaliação do Storyboard](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento/planejamento-relato_storyboard/)" na forma de um gráfico de pizza, onde são apresentadas a quantidade de "sim", "não" e "não se aplica" obtidos na verificação.
