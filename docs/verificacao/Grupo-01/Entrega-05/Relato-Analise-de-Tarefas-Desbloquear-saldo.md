# Verificação do artefato "Relato do Resultado - Análise de Tarefas Desbloquear Saldo"

## Introdução

Este documento tem como objetivo relatar os resultados da verificação por inspeção do artefato "[Relato dos Resultados da Análise de Tarefas Desbloquear Saldo](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20II/relatos%20dos%20resultados%20-%20analise%20de%20tarefas/desbloquear_saldo/)" elaborado pelo [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/) na disciplina de Interação Humano-Computador. Será analisada a versão 1.0 do documento, de 06/11/2023, feito por [Gabriel Zaranza](https://github.comGZaranza).
...
Nesse documento específico, a verificação foi feita em dupla por [Lucas Ribeiro](https://github.com/lucassouzs) e [Zenilda Vieira](https://github.com/zenildavieira). O link do vídeo dessa verificação encontra-se no final do documento (Vídeo 1), após a análise dos problemas encontrados. Foi feita também a consolidação da inspeção e correção com o autor do documento, [Gabriel Zaranza](https://github.comGZaranza), e um dos responsáveis pela inspeção, [Lucas Ribeiro](https://github.com/lucassouzs) (Vídeo 2).
...
O artefato, de maneira geral, apresenta poucos problemas; no entanto, foram identificadas algumas questões menores, as quais podem ser detalhadas nos próximos tópicos.

### Checklist geral

- **ID 07:** O artefato possui 2 tabelas ao todo, porém apenas a tabela 2 esta sendo chamada, ou seja, a tabela 1 não está sendo chamada, por isso a avaliação como "Incompleto". 
...
- **ID 11:** Em geral, pode ser considerado que o artefato segue sim o planejamento proposto pelo grupo, porém, em alguns tópicos, o artefato peca nesse seguimento.
...
<p style="text-align: center"><a href="https://youtu.be/Pf27QGInKoE" target="blanket"><b>Vídeo 1:</b> Verificação do artefato em estudo</a></p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/Pf27QGInKoE" title="Verificação" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
No vídeo 2 é possível assistir a consolidação da inspeção do artefato com o integrante do grupo [Gabriel Zaranza](https://github.comGZaranza).

<div align="center">

<p style="text-align: center"><a href="https://www.youtube.com/watch?v=xxxx" target="blanket"><b>Vídeo 2:</b> Consolidação da Inspeção e da Correção</a></p>

<iframe width="560" height="315" src="https://www.youtube.com/embed/xxxx" title="Consolidação da Inspeção" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
> NOTA LEGAL, [Relato dos Resultados da Análise de Tarefas Desbloquear Saldo](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20II/relatos%20dos%20resultados%20-%20analise%20de%20tarefas/desbloquear_saldo/), FGA, GAMA, 2023. Acesso em: 25 de novembro de 2023.
...
| `1.2`  | 03/12/2023 | Conclusão do documento  | [Lucas Ribeiro](https://github.com/lucassouzs)| [Gabriel Rosa](https://github.com/gabrielrosa09)  |
