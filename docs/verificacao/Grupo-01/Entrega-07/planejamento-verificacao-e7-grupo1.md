...
Dito isso, este documento fará a verificação da entrega 7 realizada pelo [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/), que está trabalhando com o site Nota Legal, na disciplina Interação Humano Computador.

## Objetivos

O propósito deste documento é realizar uma verificação minuciosa dos artefatos desenvolvidos pelo [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/) durante a etapa 7, que abrange os temas de Design, Avaliação e Desenvolvimento III. O objetivo é assegurar que esses artefatos estejam em plena conformidade com os requisitos estabelecidos na disciplina de Interação Humano-Computador, bem como em alinhamento com os padrões consagrados na literatura especializada nesse campo. Essa análise visa garantir a qualidade e a aderência às melhores práticas, contribuindo para o desenvolvimento de artefatos ainda melhores para o projeto.
...
<table>
  ...
  <tbody>
    <tr>
      <td><a href="#">Protótipos de Alta Fidelidade</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Planejamento da Avaliação dos Protótipos de Alta Fidelidade</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Planejamento do Relato dos Resultados dos Protótipos de Alta Fidelidade</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Relato dos Resultados - Consultar Sorteio</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Relato dos Resultados - Registrar Reclamação</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
     <tr>
      <td><a href="https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/visualizar-recibo/">Relato dos Resultados - Visualizar Recibo</a></td>
      <td>1.1</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/registrar_reclama%C3%A7%C3%A3o/">Relato dos Resultados - Registrar Reclamação</a></td>
      <td>1.0</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Relato dos Resultados - Consultar Extrato</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
    <tr>
      <td><a href="#">Relato dos Resultados - Consultar Estabelecimento</a></td>
      <td>-</td>
      <td>XX/11/2023</td>
    </tr>
  </tbody>
...
Na tabela X, estão listados os critérios que devem ser verificados no [Relato do Resultado do Protótipo de Papel "Consultar Sorteio"](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/consultar-sorteio/) do [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/).

<div align="center">
  <p><b>Tabela X:</b> Checklist de Verificação para o artefato "Relato do Resultado do Protótipo de Papel "Consultar Sorteio"</p>
  <table>
    <tr>
      <th>ID</th>
      <th>Critério</th>
...
Na tabela X, estão listados os critérios que devem ser verificados no [Relato do Resultado do Protótipo de Papel "Desbloquear Saldo"](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/desbloquear_saldo/) do [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/).

<div align="center">
  <p><b>Tabela X:</b> Checklist de Verificação para o artefato "Relato do Resultado do Protótipo de Papel "Desbloquear Saldo"</p>
  <table>
    <tr>
      <th>ID</th>
      <th>Critério</th>
...
Na tabela X, estão listados os critérios que devem ser verificados no [Relato do Resultado do Protótipo de Papel "Visualizar Recibo"](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/visualizar-recibo/) do [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/).

<div align="center">
  <p><b>Tabela X:</b> Checklist de Verificação para o artefato "Relato do Resultado do Protótipo de Papel "Visualizar Recibo"</p>
  <table>
    <tr>
      <th>ID</th>
      <th>Critério</th>
...
Na tabela X, estão listados os critérios que devem ser verificados no [Relato do Resultado do Protótipo de Papel "Consultar Reclamação"](https://interacao-humano-computador.github.io/2023.2-NotaLegal/design-avaliacao-desenvolvimento%20III/resultados-prototipo-papel/visualizar-recibo/) do [Grupo 1](https://interacao-humano-computador.github.io/2023.2-NotaLegal/).
